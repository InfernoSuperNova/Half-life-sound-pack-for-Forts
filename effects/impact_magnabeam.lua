...
dofile("mods/dlc1_weapons/effects/impact_magnabeam.lua")
SoundEvent = "mods/half-life-sound-pack/effects/impact_magnabeam"
...
-- 		Sprite = path .. "/effects/copyedmedia/magna_flare",
