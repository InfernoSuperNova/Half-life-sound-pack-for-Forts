...
LifeSpan = 1
SoundEvent = "mods/half-life-sound-pack/effects/firebeam_hit"
Beamflare = "mods/weapon_pack/effects/media/fireflare"
if Beamflare then
Effects =
{
	{
	...
	},
	{
		...
		Sprite = "mods/weapon_pack/effects/media/debris",
