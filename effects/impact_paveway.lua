	...
	},
	{
		...
		States =
		{
			Normal =
			{
				Frames =
				{
					{ texture = path .. "/effects/copyedmedia/impact_paveway01.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway02.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway03.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway04.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway05.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway06.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway07.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway08.png" },
					{ texture = path .. "/effects/copyedmedia/impact_paveway09.png" },
